...
const (
	...
	FileService_AllFIle_FullMethodName    = "/files.FileService/AllFIle"
)
...
type FileServiceClient interface {
	...
	AllFIle(ctx context.Context, in *AllRequest, opts ...grpc.CallOption) (*AllResponse, error)
}
...
func (c *fileServiceClient) AllFIle(ctx context.Context, in *AllRequest, opts ...grpc.CallOption) (*AllResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AllResponse)
	err := c.cc.Invoke(ctx, FileService_AllFIle_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type FileServiceServer interface {
	...
	AllFIle(context.Context, *AllRequest) (*AllResponse, error)
...
func (UnimplementedFileServiceServer) AllFIle(context.Context, *AllRequest) (*AllResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AllFIle not implemented")
}
...
func _FileService_AllFIle_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AllRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FileServiceServer).AllFIle(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: FileService_AllFIle_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FileServiceServer).AllFIle(ctx, req.(*AllRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var FileService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "AllFIle",
			Handler:    _FileService_AllFIle_Handler,
		},
	},
